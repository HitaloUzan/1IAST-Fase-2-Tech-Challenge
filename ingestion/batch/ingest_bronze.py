...
TABLES = {
    "alfabetizacao_uf": f"""
        ...
        SELECT
            ...
            dados.serie AS serie_codigo,
            dados.rede AS rede_codigo,
    ...
    "alunos": f"""
        ...
        SELECT
            ...
            dados.serie AS serie_codigo,
            dados.rede AS rede_codigo,
            dados.presenca AS presenca_codigo,
            dados.preenchimento_caderno AS preenchimento_caderno_codigo,
            dados.alfabetizado AS alfabetizado_codigo,
            descricao_serie AS serie,
            descricao_rede AS rede,
